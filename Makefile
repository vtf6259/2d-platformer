...
main: build/main.o build/player.o build/level.o
	gcc -ggdb -o build/2d-platformer build/main.o build/player.o build/level.o -lraylib -lm -lX11

run: main
	./build/2d-platformer
clean:
	rm -r build/2d-platformer build/main.o build/player.o build/level.o
